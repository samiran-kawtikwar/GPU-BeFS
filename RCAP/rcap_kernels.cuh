...
__forceinline__ __device__ void feas_check(const problem_info *pinfo, const node *a, bnb_stats *stats, bool &feasible)
{
...
__forceinline__ __device__ void update_bounds(const problem_info *pinfo, const node *a)
{
